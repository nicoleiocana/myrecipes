...
class ChefTest < ActiveSupport::TestCase
  ...
  def setup
    @chef = Chef.new(chefname: "testname", email: "testname@test.com")
  end
  ...
  test "should reject invalid addresses" do
    invalid_emails = %w[mashur@example
                        test@example,com
                        test@gmail.
                        joe@foo+bar.com]
  ...
  test "email should be uniqueand case insensitive" do
